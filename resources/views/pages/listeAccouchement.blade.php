        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder fs-2 mb-0">Liste des accouchements</h6>
                </nav>
                            ...
                            <div class="card-body px-0 pb-2">
                                <div class="table-responsive p-0">
                                    ...
                                    <table id="myTable" class="display table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($accouchement as $accouchement)
                                                <tr>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="">{{ $accouchement->id }}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="">{{ $accouchement->telephone }}</span>
                                                    </td>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <div class="text-center">
                                                            <a href="#" type="submit" data-bs-toggle="modal"
                                                                ...
                                                                data-id="{{ $accouchement->id }}"
                                                                class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">mettre à jour</a>
                                                        </div>
                                                    </td>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5"
                                                                        ...
                                                                        Saisir la date de l'accouchement
                                                                    </h1>


                                                                </div>
                                                                <form action="{{ route('majAccouchement') }}"
                                                                    method="get">
                                                                    <div class="modal-body">
                                                                        <div class="col-md">
                                                                            ...
                                                                            <label class="form-label"
                                                                                for="objet">date</label>
                                                                            <div
                                                                                class="input-group input-group-outline mb-3">
                                                                                <input type="date" id="date" name="date" class="form-control">
                                                                            </div>

                                                                             {{-- la description de l'accouchement --}}
                                                                            <label class="form-label"
                                                                                for="objet">description</label>
                                                                            <div
                                                                                class="input-group input-group-outline mb-3">
