                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src="{{ asset('img/small-logos/logo-asana.svg') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src="{{ asset('img/small-logos/github.svg') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src="{{ asset('img/small-logos/bootstrap.svg') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div>
                                                    <img src="{{ asset('img/small-logos/devto.svg') }}"
